...
class DailyEntrySearch extends DailyEntry {
        ...
        public function search($params) {
                ...
                if (!empty($this->received_date) && strpos($this->received_date, '-') !== false) {
                        list($start_date, $end_date) = explode(' - ', $this->received_date);

                        $query->andFilterWhere(['between', 'date(received_date)', $start_date, $end_date]);
                        $this->received_date = "";
                }
