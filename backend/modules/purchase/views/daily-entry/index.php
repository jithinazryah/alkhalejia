...
//                            'id',
                            ...
                            [
                                'attribute' => 'material',
                                'format' => 'raw',
                                'filter' => Html::activeDropDownList($searchModel, 'material', ArrayHelper::map(Materials::find()->all(), 'id', 'name'), ['class' => 'form-control', 'id' => 'name', 'prompt' => 'All']),
                                'value' => function ($data) {
                            ...
                            [
                                'attribute' => 'transport',
                                'format' => 'raw',
                                'filter' => Html::activeDropDownList($searchModel, 'transport', ArrayHelper::map(Contacts::findAll(['status' => 1, 'type' => 2, 'service' => 2]), 'id', 'name'), ['class' => 'form-control', 'id' => 'name', 'prompt' => 'All']),
                                'value' => function ($data) {
