...
//                            'id',
                                                ...
                                                [
                                                    ...
                                                    'attribute' => 'supplier',
                                                    'format' => 'raw',
                                                    'filter' => Html::activeDropDownList($searchModel, 'supplier', ArrayHelper::map(Contacts::findAll(['status' => 1, 'type' => 2, 'service' => 1]), 'id', 'name'), ['class' => 'form-control', 'id' => 'name', 'prompt' => '']),
                                                    'value' => function ($data) {
                                                    ...
                                                    'attribute' => 'transport',
                                                    'format' => 'raw',
                                                    'filter' => Html::activeDropDownList($searchModel, 'transport', ArrayHelper::map(Contacts::findAll(['status' => 1, 'type' => 2, 'service' => 2]), 'id', 'name'), ['class' => 'form-control', 'id' => 'name', 'prompt' => '']),
                                                    'value' => function ($data) {
