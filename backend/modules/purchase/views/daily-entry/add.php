                            ...
                            <tbody>
                                ...
                                if ($daily_entry->status != 0) {
                                    ...
                                    <tr class="formm">
                                        ...
                                        <td><?= $form->field($model, 'transport_amount', ['inputOptions' => ['class' => 'form-control', 'tabindex' => '5', 'placeholder' => ' Transporter Amount', 'required' => TRUE]])->label(false) ?></td>
                                        <td><?= $form->field($model, 'description', ['inputOptions' => ['class' => 'form-control', 'tabindex' => '6', 'placeholder' => ' Description', 'required' => TRUE]])->label(false) ?></td>
