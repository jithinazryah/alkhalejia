                                                        ...
                                                        <tbody>
                                                                ...
                                                                if ($appointment->status != 0) {
                                                                        ...
                                                                        <tr class="formm">
                                                                                ...
                                                                                <td></td>
                                                                                <td><?= $form->field($model, 'service_id')->dropDownList(ArrayHelper::map(common\models\TransactionCategory::findAll(['status' => 1]), 'id', 'category'), ['prompt' => '-Service-'])->label(false); ?></td>
                                                                                <?php
