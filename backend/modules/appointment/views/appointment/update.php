...
$this->title = 'Update Voyage Details: ' . $model->appointment_number;
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <ul class="nav nav-tabs nav-tabs-justified">
                    <li  class="active">
                        <?php
                        echo Html::a('<span class="visible-xs"><i class="fa-home"></i></span><span class="hidden-xs">Voyage Details</span>', ['appointment/create', 'id' => $model->id]);
                        ?>
