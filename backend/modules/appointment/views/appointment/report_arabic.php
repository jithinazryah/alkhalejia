...
<div id="print">
    ...
    <table class="main-tabl" border="0" style="font-family: Roboto, sans-serif !important;">
        ...
        <tbody>
            <tr>
                <td>
                    <div class="heading"><h2 style="font-size:17px;letter-spacing: 4px;padding-top: 10px;">فاتورة ضريبية</h2></div>
                    <br/>
                    ...
                    <div class="invoice-details"style="margin-top: 10px;min-height: 375px;">
                        <table style="width:100%;border-collapse: collapse;text-align: left;">
                            <tr style="background: #4e5254;color: white !important;">
                                <th style="width: 10%;font-size: 12px;padding: 10px 5px;">Sl No.<br/>رقم سري</th>
                                <th style="width: 40%;font-size: 12px;padding: 10px 2px;">Particulars<br/>تفاصيل</th>
                                <th style="width: 13%;font-size: 12px;padding: 10px 2px;text-align: right;">Qty<br/>الكمية</th>
                                <th style="width: 11%;font-size: 12px;padding: 10px 2px;text-align: right;">Price<br/>السعر</th>
                                <th style="width: 15%;font-size: 12px;padding: 10px 2px;text-align: right;">Amount<br/>كمية</th>
                                <th style="width: 11%;font-size: 12px;padding: 10px 2px;text-align: right;">Tax Amount<br/>قيمة الضريبة</th>
                            </tr>
                            <?php
                            $p = 0;
                            $total_amount = 0;
