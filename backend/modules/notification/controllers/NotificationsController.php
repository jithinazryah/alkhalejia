...
class NotificationsController extends Controller {
    ...
    public function actionIndex() {
        ...
        if (!empty(Yii::$app->request->queryParams['NotificationsSearch']['status'])) {
            $dataProvider->query->andWhere(['status' => Yii::$app->request->queryParams['NotificationsSearch']['status']]);
        } else {
