        ...
        <div class="row">
                <div class='col-md-4 col-sm-6 col-xs-12 left_padd'>    <?php
                        echo $form->field($model, 'category')->widget(Select2::classname(), [
                            'data' => \common\models\ServiceCategory::Category(),
                            'language' => 'en',
                ...
                </div><div class='col-md-4 col-sm-6 col-xs-12 left_padd'>    <?= $form->field($model, 'service')->textInput(['maxlength' => true]) ?>

                </div><div class='col-md-4 col-sm-6 col-xs-12 left_padd'>    <?= $form->field($model, 'supplier_option')->dropDownList(['1' => 'Yes', '2' => 'No']) ?>
                ...
                </div><div class='col-md-4 col-sm-6 col-xs-12 left_padd'>    <?= $form->field($model, 'unit_rate')->textInput(['maxlength' => true]) ?>
